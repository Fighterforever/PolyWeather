        ...
        records.append(
            {
                ...
                "market_close_time": settlement_spec.get("market_close_time") or settlement_spec.get("end_time"),
                "observation_window_end_time": settlement_spec.get("observation_window_end_time"),
                "settlement_due_time": settlement_spec.get("settlement_due_time"),
                "settlement_grace_hours": settlement_spec.get("settlement_grace_hours"),
