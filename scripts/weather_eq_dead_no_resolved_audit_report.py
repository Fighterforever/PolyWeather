...
from src.trading.weather_eq_dead_no_markout import load_jsonl  # noqa: E402
from src.trading.weather_eq_dead_no_resolved_audit import build_eq_dead_no_resolved_audit_report  # noqa: E402


def parse_args(argv: Optional[list[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build eq-dead-NO resolved audit report.")
    ...
    parser.add_argument("--audit-output", default="evidence/eq_dead_no/resolved_audits.jsonl")
    parser.add_argument("--summary-output", default="evidence/eq_dead_no/resolved_audit_report.json")
