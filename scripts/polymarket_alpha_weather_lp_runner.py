...
def main(argv: list[str] | None = None) -> None:
    ...
    commands = [
        ...
        [args.python_path, "scripts/polymarket_alpha_weather_lp_reward_discovery_report.py", "--generated-at", generated_at],
        ...
        [args.python_path, "scripts/polymarket_alpha_weather_lp_strategy_report.py"],
