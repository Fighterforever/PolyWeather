...
DEFAULT_OUTPUT = Path("evidence/maker_shadow_v2/maker_shadow_v2_rolling_funnel_report.json")
...
def build_funnel_report_from_paths(
    ...
    *,
    ...
    report = build_maker_shadow_v2_funnel_report(
        ...
        min_required_window_hours=min_required_window_hours,
    )
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--min-required-window-hours", type=float, default=6.0)
...
def main(argv: list[str] | None = None) -> None:
    ...
    report = build_funnel_report_from_paths(
        ...
        min_required_window_hours=float(args.min_required_window_hours),
    )
