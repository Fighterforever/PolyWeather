...
def test_reward_window_does_not_assume_40_51_without_observations():
    ...
    assert report["confidence"] == "insufficient_window_observations"
    assert report["40_to_51_minute_support_count"] == 0


def test_reward_window_counts_40_51_support():
    rows = [{"generated_at": f"2026-06-29T10:{minute:02d}:00Z", "reward_available_count": 1} for minute in range(40, 52)]
